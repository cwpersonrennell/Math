# -*- coding: utf-8 -*-
"""
Created on Tue Apr 22 16:56:35 2025
...
class Network(object):
    ...
    def SGD(self, training_data, epochs, mini_batch_size, eta, test_data = None):
        ...
        inputs and the desired outputs. Teh other non-optional parameters
    ...
    def evaluate(self, test_data):
        test_results = (np.argmax(self.feedforward(test_data[0])), test_data[1])
